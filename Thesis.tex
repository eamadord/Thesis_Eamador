...
Madrid, el d\'{i}a XX de MM de AAAA. %\mynote{DD de YYYY de 2015}

\vspace{10mm}
Presidente:\hspace{0.3mm} PRESIDENTE PRESIDENTE PRESIDENTE

\vspace{5mm}
Vocal: \hspace{6.7mm} VOCAL1 VOCAL1 VOCAL1

\vspace{5mm}
Vocal: \hspace{6.7mm} VOCAL2 VOCAL2 VOCAL2

\vspace{5mm}
Vocal: \hspace{6.7mm} VOCAL3 VOCAL3 VOCAL3

\vspace{5mm}
Secretario:\hspace{0.67mm} SECRETARIO SECRETARIO SECRETARIO

\vspace{5mm}
Suplente: \hspace{1.5mm} SUMPLENTE1 SUPLENTE1 SUPLENTE1   

\vspace{5mm}
Suplente: \hspace{1.5mm} SUPLENTE2 SUPLENTE2 SUPLENTE2
...
\cleardoublepage
\input{0_frontmatter/glossary.tex}
...
\input{4_kbsintegrationdl/kbsintegrationdl}

\input{5_dlintegrationkbs/dlintegrationkbs}

\input{6_kbsextractiondl/kbsextractiondl}

\input{7_conclusions/conclusions}
