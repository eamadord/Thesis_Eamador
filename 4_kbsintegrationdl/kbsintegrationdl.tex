...
\paragraph{Theoretical Background.} \label{subsec:s4_theoretical_back}
...
\paragraph{Ontology Retrieval.} \label{subsec:s4_onto_retrieval}
...
\paragraph{Entity Knowledge Encoding.}\label{subsec:s4_entity_encode}
...
\paragraph{Embedding Composition.} \label{subsec:s4_embedding_compo}
...
\subsection{Semantic-Based Initialization Evaluation}\label{4_sec:experiments}
...
\paragraph{Simple Entity Initialization.}
...
\paragraph{Semantic-Based Initialization.}
...
\paragraph{OOKB Entity Reasoning.}
