...
\section{Ontology Introduction to Knowledge Graph Embedding Models for Knowledge Graph Completion} \label{subsec:ontointro_kgc}
...
\elvitodo{FIGURA CON EL RESUMEN DEL METODO}
%%Decir que se realiza offline asi que no afecta a la complejidad del modelo. OBTENIDOOOO

% PROBLEMA MODELOS EXISTENTES: (i) they cannot be applied to any KG embedding model, (ii) they rely on complex representations, such as graph neural networks, and (iii) they require, at least partially, a retraining of the model to introduce new entities. 
