...
\begin{figure}[t!]
    \centering
    \subfigure[Knowledge Graph Embedding \label{fig:van_bekkum_kgc_kge}]{\includegraphics[width=.9\columnwidth]{3_stateoftheart/figures/vanBekkum_LinkPrediction.eps}}
    \subfigure[Graph Neural Network \label{fig:van_bekkum_kgc_gnn}]{\includegraphics[width=.9\columnwidth]{3_stateoftheart/figures/vanBekkum_GNN.eps}}
...
\begin{figure}[t!]
    \centering
    \subfigure[Ontology Learning \label{fig:van_bekkum_onto_learning}]{\includegraphics[width=.9\columnwidth]{3_stateoftheart/figures/VanBekkum_OntologyLearning.eps}}
    \subfigure[Instance-based Explaination \label{fig:van_bekkum_explain}]{\includegraphics[width=.9\columnwidth]{3_stateoftheart/figures/VanBekkum_Explainability.eps}}
    \caption{Design pattern of two knowledge extraction models according to \cite{van_bekkum_modular_2021}}
    \label{fig:van_bekkum_explain}
\end{figure}
...
\elvitodo{No sé si es buena idea o no, de cara a la legibilidad, añadir aquí las limitaciones. Por coherencia y por separar el contenido original del propio, quizás sea mejor añadirlo como una sección al inicio del próximo capítulo}